...
export declare class ImgSrcStyleBuilder extends StyleBuilder {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ImgSrcStyleBuilder, never>;
}
export declare class ImgSrcDirective extends BaseDirective2 {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ImgSrcDirective, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<ImgSrcDirective, never, never, { "src": "src"; }, {}, never>;
}
/**
...
export declare class DefaultImgSrcDirective extends ImgSrcDirective {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<DefaultImgSrcDirective, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<DefaultImgSrcDirective, "  img[src.xs],    img[src.sm],    img[src.md],    img[src.lg],   img[src.xl],  img[src.lt-sm], img[src.lt-md], img[src.lt-lg], img[src.lt-xl],  img[src.gt-xs], img[src.gt-sm], img[src.gt-md], img[src.gt-lg]", never, { "src.xs": "src.xs"; "src.sm": "src.sm"; "src.md": "src.md"; "src.lg": "src.lg"; "src.xl": "src.xl"; "src.lt-sm": "src.lt-sm"; "src.lt-md": "src.lt-md"; "src.lt-lg": "src.lt-lg"; "src.lt-xl": "src.lt-xl"; "src.gt-xs": "src.gt-xs"; "src.gt-sm": "src.gt-sm"; "src.gt-md": "src.gt-md"; "src.gt-lg": "src.gt-lg"; }, {}, never>;
}
